...
/**
 * A change event that returns its source as a generic type. Can be used as an alternative superclass to
 * {@link ChangeEvent} if a certain return type for {@link #getSource()} is needed.
 * 
