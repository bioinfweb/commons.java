...
public class DecimalInput {
  ...
  private void setSliderValue(double currentValue) {
  	//TODO Lösung finden, die positive und negative Werte zulässt, keine krummen Schrittlängen anzeigt und einen ausreichenden Bereich darstellt. => Scala müsste sich immer bei Überschreiten einer Zehnerpotenz ändern (ggf. auch Zwischenschritte wie 1, 5, 10, 50, ...)
